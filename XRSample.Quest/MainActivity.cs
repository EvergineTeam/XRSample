...
namespace XRSample.Quest
{
    ...
    public class MainActivity : Activity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            // Create Services
            WindowsSystem windowsSystem = new Evergine.AndroidView.AndroidWindowsSystem(this);
            application.Container.RegisterInstance(windowsSystem);
            var surface = windowsSystem.CreateSurface(0, 0) as Evergine.AndroidView.AndroidSurface;
